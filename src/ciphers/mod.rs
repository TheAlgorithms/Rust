...
pub use morse_code::{encode, decode};
pub use polybius::{encode_ascii, decode_ascii};
pub use rail_fence::{rail_fence_encrypt, rail_fence_decrypt};
pub use rot13::rot13;
pub use salsa::salsa20;
pub use sha256::SHA256;
pub use tea::{tea_encrypt, tea_decrypt};
