...
pub fn sum_of_harmonic_progression(first_term: f64, common_difference: f64, number_of_terms: i32) -> f64 {
    ...
    let harmonic_series: Vec<f64> = arithmetic_progression.into_iter().map(|step| 1.0 / step).collect();
