...
mod tests {
    ...
    #[test]
    fn equal_strings() {
        assert_eq!(0, optimized_levenshtein_distance("Hello, world!", "Hello, world!"));
        assert_eq!(0, optimized_levenshtein_distance("Hello, world!", "Hello, world!"));
        assert_eq!(0, optimized_levenshtein_distance("Test_Case_#1", "Test_Case_#1"));
        assert_eq!(0, optimized_levenshtein_distance("Test_Case_#1", "Test_Case_#1"));
    }

    #[test]
    fn one_edit_difference() {
        assert_eq!(1, optimized_levenshtein_distance("Hello, world!", "Hell, world!"));
        assert_eq!(1, optimized_levenshtein_distance("Test_Case_#1", "Test_Case_#2"));
        assert_eq!(1, optimized_levenshtein_distance("Test_Case_#1", "Test_Case_#10"));
        assert_eq!(1, optimized_levenshtein_distance("Hello, world!", "Hell, world!"));
        assert_eq!(1, optimized_levenshtein_distance("Test_Case_#1", "Test_Case_#2"));
        assert_eq!(1, optimized_levenshtein_distance("Test_Case_#1", "Test_Case_#10"));
    }
    ...
    fn several_differences() {
        ...
        assert_eq!(7, optimized_levenshtein_distance("Hello, world!", "Goodbye, world!"));
